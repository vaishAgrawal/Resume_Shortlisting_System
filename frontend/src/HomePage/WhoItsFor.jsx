const CARDS = [
  ...
  },
  {
    ...
    image: "/images/Job_Interview.jpg"
  },
  {
...
export default function WhoItsFor() {
  return (
    <section className="py-20 bg-gradient-to-br from-[#f7f3ff] via-[#f1edff] to-[#ece7ff]">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-14">
          <span className="inline-flex items-center justify-center px-6 py-2 rounded-full text-sm font-semibold bg-[#ede7ff] text-[#5b3db8] shadow-sm font-body">
            Our users
          </span>
          <h2 className="mt-6 text-4xl md:text-5xl lg:text-6xl font-bold text-[#2a184b] font-display">
            Who It&apos;s For
          </h2>
          <p className="mt-4 text-[#5b4b8a] max-w-3xl mx-auto font-body">
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          {CARDS.map((card) => (
            ...
            >
              ...
              <div className="relative p-7 md:p-9 min-h-[300px] flex flex-col justify-end">
